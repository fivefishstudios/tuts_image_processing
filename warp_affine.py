...
img = cv2.imread('./scope.JPG') 

height, width = img.shape[:2] 
pts_1 = np.float32([[95,145],[385,45],[135,230]])
pts_2 = np.float32([[125,45],[385,45],[150,230]])
Matrix = cv2.getAffineTransform(pts_1, pts_2)
final_img = cv2.warpAffine(img, Matrix, (width, height))

cv2.imshow('Affine Transform', final_img)
cv2.waitKey(0)